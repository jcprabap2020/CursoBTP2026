CLASS zcl_load_data_jp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_load_data_jp IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    DATA: lti_brands   TYPE STANDARD TABLE OF zrent_brands_jp,
          lti_cars     TYPE STANDARD TABLE OF zrent_cars_jp,
          lti_customer TYPE STANDARD TABLE OF zrent_custome_jp.

    lti_cars = VALUE #(
                        ( matricula = '1246GSA' marca = 'BMW' modelo = 'SERIE 4' color = 'BLANCO' motor = '2.5'
                          potencia = '210' und_potencia = 'CV' combustible = 'GASOLINA' consumo = '7.00'
                          fecha_fabr = '20200418' puertas = '5' precio = '210' moneda = 'USD'
    ...
    delete from zrent_cars_jp.
    insert zrent_cars_jp from table @lti_cars.
    select count( * )  from zrent_cars_jp into @data(li_tot).
    out->write( li_tot ).
*-------------------------------------------------------------------------------------------
lti_customer = VALUE #(
...
email = 'parker.slater@email.com' cntr_type = 'C3'
    ...
    delete from zrent_custome_jp.
    insert zrent_custome_jp from table @lti_customer.
    select count( * )  from zrent_custome_jp into @li_tot.
    out->write( li_tot ).
*--------------------------------------------------------------------------------
...
( marca = 'FORD' url = 'https://www.elsoldemexico.com.mx/deportes/automotri z/1i0d6x-02_2019.png/ALTERNATES/LANDSCAPE_400/02_2019.png' )
...
( marca = 'BMW' url = 'https://www.bmw.com.mx/content/dam/bmw/common/all-models/3-series/sedan/2018/navigation/bmw-3-series-modellfinder.png' ) ).
    ...
    insert zrent_brands_jp from table @lti_brands.
    select count( * )  from zrent_brands_jp into @li_tot.
    out->write( li_tot ).
